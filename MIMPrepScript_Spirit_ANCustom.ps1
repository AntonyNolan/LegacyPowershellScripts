...
#- AN Note Replace with hard code for client, supports SID Migration
### Questions
##########################################################################
...
#AN Note: Change csv to correct value
...
##########################################################################
function Create-OUs
## AN Note: Added ProtectedFromAccidentalDeletion for test domain cleanup and laziness
	{
...
#AN Add MIMSync SPN Variables
	    ##MIMSync/(Server MIM Sync is installed on own server) Variables
	    $MIMSyncSPN = "$MIMSync/$SyncSVR"
	    $MIMSyncSPNFQDN = "$MIMSyncSPN.$DomainDNSR"
...
#AN Add Sync Service Account to FIMSync
        setspn.exe -S $MIMSyncSPN $DomainMIMSVC
